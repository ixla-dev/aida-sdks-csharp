...
namespace Aida.Sdk.Mini.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.713";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.713/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.713\n";
            report += "    SDK Package Version: 1.0.713\n";
