...
namespace Aida.Sdk.Api
{
    ...
    public partial class ModbusApi : IDisposable, IModbusApi
    {
        ...
        public Aida.Sdk.Client.ApiResponse<string> AidaV1ModbusPortSlaveIdHexRegistersGetWithHttpInfo(string port, string slaveIdHex, string startHex = default(string), string lengthHex = default(string))
        {
            ...
            if (startHex != null)
            {
                localVarRequestOptions.QueryParameters.Add(Aida.Sdk.Client.ClientUtils.ParameterToMultiMap("", "startHex", startHex));
            }
            if (lengthHex != null)
            {
                localVarRequestOptions.QueryParameters.Add(Aida.Sdk.Client.ClientUtils.ParameterToMultiMap("", "lengthHex", lengthHex));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<string>("/aida/v1/modbus/{port}/{slaveIdHex}/registers", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Aida.Sdk.Client.ApiResponse<string>> AidaV1ModbusPortSlaveIdHexRegistersGetWithHttpInfoAsync(string port, string slaveIdHex, string startHex = default(string), string lengthHex = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<string>("/aida/v1/modbus/{port}/{slaveIdHex}/registers", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
