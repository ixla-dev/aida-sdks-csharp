...
namespace Aida.Sdk.Api
{
    ...
    public interface IModbusApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void WriteSingleRegister(string port, string slaveId, string address, string value = default(string));
        ...
        /// <param name="value"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> WriteSingleRegisterWithHttpInfo(string port, string slaveId, string address, string value = default(string));
    ...
    public interface IModbusApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task WriteSingleRegisterAsync(string port, string slaveId, string address, string value = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> WriteSingleRegisterWithHttpInfoAsync(string port, string slaveId, string address, string value = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ModbusApi : IDisposable, IModbusApi
    {
        ...
        /// <param name="value"> (optional)</param>
        /// <returns></returns>
        public void WriteSingleRegister(string port, string slaveId, string address, string value = default(string))
        {
            WriteSingleRegisterWithHttpInfo(port, slaveId, address, value);
        }
        ...
        /// <param name="value"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Aida.Sdk.Client.ApiResponse<Object> WriteSingleRegisterWithHttpInfo(string port, string slaveId, string address, string value = default(string))
        {
            // verify the required parameter 'port' is set
            if (port == null)
                throw new Aida.Sdk.Client.ApiException(400, "Missing required parameter 'port' when calling ModbusApi->WriteSingleRegister");

            // verify the required parameter 'slaveId' is set
            if (slaveId == null)
                throw new Aida.Sdk.Client.ApiException(400, "Missing required parameter 'slaveId' when calling ModbusApi->WriteSingleRegister");

            // verify the required parameter 'address' is set
            if (address == null)
                throw new Aida.Sdk.Client.ApiException(400, "Missing required parameter 'address' when calling ModbusApi->WriteSingleRegister");
            ...
            localVarRequestOptions.PathParameters.Add("port", Aida.Sdk.Client.ClientUtils.ParameterToString(port)); // path parameter
            localVarRequestOptions.PathParameters.Add("slaveId", Aida.Sdk.Client.ClientUtils.ParameterToString(slaveId)); // path parameter
            localVarRequestOptions.PathParameters.Add("address", Aida.Sdk.Client.ClientUtils.ParameterToString(address)); // path parameter
            if (value != null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/aida/v1/modbus/{port}/{slaveId}/registers/{address}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task WriteSingleRegisterAsync(string port, string slaveId, string address, string value = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await WriteSingleRegisterWithHttpInfoAsync(port, slaveId, address, value, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Aida.Sdk.Client.ApiResponse<Object>> WriteSingleRegisterWithHttpInfoAsync(string port, string slaveId, string address, string value = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'port' is set
            if (port == null)
                throw new Aida.Sdk.Client.ApiException(400, "Missing required parameter 'port' when calling ModbusApi->WriteSingleRegister");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/aida/v1/modbus/{port}/{slaveId}/registers/{address}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
