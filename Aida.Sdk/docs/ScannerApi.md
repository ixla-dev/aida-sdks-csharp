...
<a id="assigninkjetlayouttojobtemplate"></a>
...
<a id="assigninkjetlayoutstojobtemplate"></a>
...
<a id="removeinkjetlayoutfromjobtemplate"></a>
...
<a id="setreadbackconfiguration"></a>
...
# **UpdateEntities**
> ScannerAppStateDto UpdateEntities (string scannerId = null, List<FileParameter> assets = null, Dictionary<string, string> data = null, Dictionary<string, TransformOptions> transforms = null)
...
namespace Example
{
    public class UpdateEntitiesExample
    {
        public static void Main()
        {
            ...
            var data = new Dictionary<string, string>(); // Dictionary<string, string> |  (optional) 
            var transforms = new Dictionary<string, TransformOptions>(); // Dictionary<string, TransformOptions> |  (optional) 

            try
            {
                // Updates entity text/image data
                ScannerAppStateDto result = apiInstance.UpdateEntities(scannerId, assets, data, transforms);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Updates entity text/image data
    ApiResponse<ScannerAppStateDto> response = apiInstance.UpdateEntitiesWithHttpInfo(scannerId, assets, data, transforms);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
| **data** | [**Dictionary&lt;string, string&gt;**](Dictionary.md) |  | [optional]  |
| **transforms** | [**Dictionary&lt;string, TransformOptions&gt;**](Dictionary.md) |  | [optional]  |
...
<a id="updatemirroringsettings"></a>
